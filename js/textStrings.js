...
var textStrings_EN = {
    // Act 1
    "niceHat"              : "VAY GÜZEL ŞAPKA"                                       ,
    "outtaHere"            : "evet defol git buradan"                                ,
    "getARoom"             : "İĞRENÇ, KAPALI ALANDA YAPIN ŞUNU"                      ,
    "notCoolAnymore"       : "boşver şapkalar artık havalı değil"                    ,
    "tvOnTv"               : "TELEVİZYON... İÇİNDE TELEVİZYON!"                      ,
    "cricky"               : "KÜÇÜK CIRCIR <3"                                       ,
    "tooManyCrickets"      : "çok fazla cırcırböceğiokay"                            ,
    "normalPeep"           : "normal biri"                                           ,
    "normalPeeps"          : "normal insanlar"                                       ,
    "wowNothing"           : "HEY, BU HİÇ BİR ŞEY"                                   ,
    
    // Act 2
    "crazySquareAttacks"   : "DELİ KARE SALDIRIYOR"                                  ,
    "justMissed"           : "oooooh kaçırdın"                                       ,
    "somethingInteresting" : "(onları ilginç *bir şey* yaparken yakalamalısın...)"   ,
    "whoIsScreaming"       : "(kim bağırıyorsa onu yakalamalısın)"               ,
    "circleFearsSquares"   : "ÇEMBERLER KARELERDEN KORKUYOR"                                  ,
    "whoScaresThem"        : "(*kim* korkuttuysa onu da yakalamalısın)"         ,
    "areTheyScared"        : "(kare tarafından korkutuluyorken yakalamalısın)"       , // not used
    "squaresSnubCircles"   : "KARELER ÇEMBERLERİ TERSLİYOR"                                  ,
    "areTheySnubbed"       : "(onları çemberi terslerken yakalamalısın)"        , // not used
    "everyoneHates"        : "HERKES BİRBİRİNDEN NEFRET EDİYOR!!!"                           ,
    "almostEveryoneHates"  : "NEREDEYSE HERKES BİRBİRİNDEN NEFRET EDİYOR..."                     ,
    ...
    "nerdsNow"             : "bu inekler şimdi neyin peşinde"                        ,
    "schockedPeep"         : "bu insanlar neden sarsılmış?"                              ,
    "whatever"             : "herneyse"                                              ,
    
    // Act 3
    "ellipsis"             : ". . ."                                                 ,
    "coolNoMore"           : "şapkalar artık havalı değil, duymadın mı?"           ,
    "beScared"             : "KORKUN. ÖFKELENİN."                                  ,
    
    // MANIFESTO
    "manifesto" : [
       //"as if you viewers want GOOD news"       ,
       "*mutlu insanlar*ı kim izler?",
       "barış sıkıcı. şiddet viral olur."    ,
       //"peace is boring. conflict gets clicks." ,
       "her hikâye de bir fikir ayrılığı olur, öyleyse..."  ,
       //"...GIVE THE AUDIENCE WHAT THEY WANT."   ,
       "İZLEYİCİYE İSTEDİKLERİNİ VER."
    ] ,
    ...
    // (chyron3.png)
    "chyronNothing"      : "VAVVV, *HİÇBİR ŞEY",
    ...
    // (credits0002.png)
    "manyThanks"         : "tüm deneyenlere çok teşekkürler:" ,
    
    // (credits000[3,4,5,6].png)
    "patreonSupporters"  : "ve patreon destekcilerime:" ,
    ...
    "otherWorkButton"    : "diğer çalışmalarımı görün" ,
    "buyCoffeeButton"    : "bana bir kahve ısmarlayın" ,
    "replayButton"       : "bu karışıklığı bir daha oynayın" ,
    
    // (logo.png) Post Credits
    "logoWBWWB"          : "ACIYI PAYLAŞIN:" ,
    ...
    // (quote0002.png)
    "WBWWB"              : "İzlediğimiz şeye dönüşürüz." ,
    "WSOTATOTSU"         : "Kullandığımız araçları biz yaparız, ardından bu araçlar bizi biz yapar." ,
